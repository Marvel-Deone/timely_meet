    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Set your weekly schedule and booking preferences</p>
        </div>
      </div>
        ...
        <Card className="bg-white border shadow-sm">
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">Booking Buffer</p>
      ...
      <Card className="bg-white border shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Select the days and times when you're available for meetings. Changes are saved automatically.
          </CardDescription>
        </CardHeader>
        <CardContent>
